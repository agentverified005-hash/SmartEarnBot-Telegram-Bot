...
if not TOKEN:
    print("ERROR: BOT_TOKEN env var not set on Render!")
if not MONGO_URL:
    print("ERROR: MONGO_URL env var not set on Render!")
...
def main():
    # Start Flask IN main, not at import time - this fixes the event loop error
